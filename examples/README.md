...
|---|---|
| [`web-demo/`](web-demo/) | Browser page that uploads a document and paints each page event live: provenance boxes on a canvas, reading-order text, tables, picture classes, barcodes. `docker compose --profile demo up --build` and open <http://localhost:8080>. |
