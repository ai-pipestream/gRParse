...
#
# Full check (--full, needs models/ populated next to this repo, or
# SMOKE_MODELS_DIR pointing at a populated directory): boots the server on
# the CPU provider and streams a fixture through the bundled client,
# asserting a page event and the terminal complete event.
#
